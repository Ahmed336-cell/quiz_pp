...
import 'package:quiz_pp/home_page.dart';
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context)=>HomePage()));
                    ...
                    Column(
                      children: [
                        ...
                        SizedBox(height: 10,),
                        Text("Share score" , style: TextStyle(fontSize: 15,fontWeight: FontWeight.w500),)
                      ],
                    )
                  ],
                ),
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        SizedBox(height: 10,),
                        Text("Generate PDF" , style: TextStyle(fontSize: 15,fontWeight: FontWeight.w500),)
                      ],
                    ),
                    Column(
                      children: [
                    ...
                    Column(
                      children: [
                        CircleAvatar(
                          ...
                          radius: 35,
                          child: Center(
                            child: Icon(Icons.settings_applications,size: 35,color: Colors.white,),
                          ),
                        ),
                        SizedBox(height: 10,),
                        Text("Leaderboard" , style: TextStyle(fontSize: 15,fontWeight: FontWeight.w500),)
                      ],
                    )
                  ],
                ),
